 ...
 *
 * @export
 * @class SasCredentialPolicy
 * @extends {CredentialPolicy}
 */
var SasCredentialPolicy = /** @class */ (function (_super) {
    __extends(SasCredentialPolicy, _super);
    /**
     * Creates an instance of SasCredentialPolicy.
     * @param {RequestPolicy} nextPolicy
     * @param {RequestPolicyOptions} options
     * @param {SasCredential} tokenCredential
     * @memberof SasCredentialPolicy
     */
    function SasCredentialPolicy(nextPolicy, options, tokenCredential) {
        var _this = _super.call(this, nextPolicy, options) || this;
        _this.tokenCredential = tokenCredential;
        _this.authorizationScheme = HeaderConstants.SAS_SCHEME;
        return _this;
    }
    /**
     ...
     * @memberof SasCredentialPolicy
     */
    SasCredentialPolicy.prototype.signRequest = function (request) {
        if (!request.headers) {
 ...
 *
 */
var SasCredential = /** @class */ (function (_super) {
    __extends(SasCredential, _super);
    /**
     * Creates an instance of SasCredential.
     * @param {string} token
     * @memberof SasCredential
     */
    function SasCredential(token) {
        var _this = _super.call(this) || this;
        _this.token = token;
        return _this;
    }
     ...
     * @param {RequestPolicy} nextPolicy
     * @param {RequestPolicyOptions} options
     * @returns {SasCredentialPolicy}
     * @memberof SasCredential
     */
    SasCredential.prototype.create = function (nextPolicy, options) {
        return new SasCredentialPolicy(nextPolicy, options, this);
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2: return [2 /*return*/, _b.apply(_a, [_f.sent(), { rawResponse: response._response }])];
                    case 3:
                    ...
                    case 5: return [2 /*return*/, _d.apply(_c, [_f.sent(), { rawResponse: response._response }])];
...
exports.SasCredential = SasCredential;
exports.SasCredentialPolicy = SasCredentialPolicy;
